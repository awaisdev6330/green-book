...
export default function HomeOrderSection() {
  return (
    <>
      <div className="relative mx-auto flex max-w-12xl flex-col items-center text-center mt-32 sm:mt-40 xl:mx-auto xl:max-w-7xl xl:px-8 bg-gray-900 px-6 py-24 sm:py-32 lg:px-8">
